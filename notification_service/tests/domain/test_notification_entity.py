...
class TestNotificationEntity:
    ...
    @pytest.mark.parametrize(
        "invalid_channel",
        [None, True, "This string is not Enum", 1000, -15, StatusEnum],
    )
    ...
    def test_entity_is_immutable(self, sample_notification_entity):
    ...
    def test_notification_entity_invalid_idempotency_key(
        self, sample_message_value_object, invalid_value
    ):
