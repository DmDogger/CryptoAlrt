...
from ..fixtures.notification_fixtures import sample_notification_entity, sample_idempotency_key
...
class TestSQLAlchemyNotificationRepository:
    ...
    async def test_correct_saved_entity(
        ...
        mock_notification_mapper.from_database_model.assert_called_with(sample_notification_db_model)
