...
class BrokerSettings(BaseSettings):
    ...
    price_updates_topic: str = Field(default="price-updates", alias="KAFKA_PRICE_UPDATES_TOPIC")
    alert_created_topic: str = Field(default="alert-created", alias="KAFKA_ALERT_CREATED_TOPIC")

    alert_deleted_topic: str = Field(default="alert-deleted", alias="KAFKA_ALERT_DELETED_TOPIC")

    alert_updated_topic: str = Field(
        default="alert-updated-topic", alias="KAFKA_ALERT_UPDATED_TOPIC"
    )

    alert_triggered_topic: str = Field(default="alert-triggered", alias="KAFKA_ALERT_TRIGGERED")
