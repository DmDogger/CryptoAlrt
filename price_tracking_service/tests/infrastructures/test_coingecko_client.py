...
class TestCoinGeckoClient:
    ...
    async def test_fetch_price_success(
        self, coingecko_client, mock_httpx_client, mock_coingecko_response
    ):
    ...
    @pytest.mark.asyncio
    async def test_fetch_price_http_error(self, coingecko_client, mock_httpx_client):
    ...
    @pytest.mark.asyncio
    async def test_fetch_price_request_error(self, coingecko_client, mock_httpx_client):
    ...
    @pytest.mark.asyncio
    async def test_fetch_price_key_error(self, coingecko_client, mock_httpx_client):
