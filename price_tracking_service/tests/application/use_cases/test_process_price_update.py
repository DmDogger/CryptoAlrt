...
class TestProcessPriceUpdateUseCase:
    ...
    async def test_execute_success(
        ...
        # Arrange
        coin_id = "bitcoin"
        mock_fetch_and_save_use_case.execute.return_value = (sample_crypto_entity, sample_price)
    ...
    async def test_execute_with_zero_price(
        ...
        mock_fetch_and_save_use_case.execute.return_value = (sample_crypto_entity, zero_price)
    ...
    async def test_execute_with_high_precision_price(
        ...
        mock_fetch_and_save_use_case.execute.return_value = (sample_crypto_entity, precise_price)
