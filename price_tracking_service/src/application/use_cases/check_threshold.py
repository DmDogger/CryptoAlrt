...
class CheckThresholdUseCase:
    ...
    async def execute(self, cryptocurrency: str, current_price: Decimal) -> None:
        ...
        try:
            ...
            alerts = await self._alert_repository.get_active_alerts_by_name(
            ...
            for alert in alerts:
                if CheckThresholdService.check_threshold(
                    ...
                    await self._event_publisher.publish(
                        topic=broker_settings.alert_triggered_topic, event=trigger_event
                    )
