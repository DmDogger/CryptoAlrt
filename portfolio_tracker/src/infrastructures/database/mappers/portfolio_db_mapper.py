...
class PortfolioDBMapper:
    ...
    def from_database(model: Portfolio) -> PortfolioEntity:
        ...
        return PortfolioEntity(
            ...
            assets=[AssetDBMapper.from_database(asset) for asset in model.assets] if model.assets else None,
    ...
    def to_dict(portfolio: PortfolioEntity) -> dict:
        ...
        return {
            ...
            "portfolio_total": str(portfolio.portfolio_total) if portfolio.portfolio_total else None,
